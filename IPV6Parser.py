...
def get_test_string(length=500, hidden_ips=1):
    ...
    s = ''.join(random.choices(string.ascii_letters + ' ' + string.digits + string.punctuation, k=length-total_ip_length))
